...
test("As a signed in segmented customer i should be able to opt-in to loyalty scheme even if i already already opted in", 13, function() {
	...
	ok(true,'Then I am on Home page');
	ok(true,'When I sign-in as an existing customer');
	ok(true,'And I am part of the selected segment for the loyalty scheme');
	ok(true,'And I have received an E-mail with a link to the loyalty services');
	ok(true,'And I follow the E-mail link');
	ok(true,'When I choose to opt-in');
	ok(true,'Then I am directed to the loyalty hub');
});
